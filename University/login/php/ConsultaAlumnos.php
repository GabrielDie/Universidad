            ...
            <table class="table mt-5">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th scope="col">Apellido_Alumno</th>
                        <th scope="col">Carrera_Alumno</th>
             ...
             <tbody>
                ...
                <tr>
                    ...
                    <td><a class="btn btn-info" href="modificarAlumnos.php?matricula=<?php echo $row['matricula'];?>">Edit</a>&nbsp;
                    <a class="btn btn-danger" href="eliminaralumnos.php?matricula=<?php echo $row['matricula'];?>">Delete</a>&nbsp;
                    </td>
                </tr>
                <?php
                    }
